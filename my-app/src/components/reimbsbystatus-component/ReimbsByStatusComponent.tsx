...
export class ReimbsByStatusComponent  extends React.Component<any,IViewAllUsersProps> 
 {
...
axios.get('http://ec2-18-216-91-68.us-east-2.compute.amazonaws.com:2002/reimbursements/status/'+statusid, 
...
return(
  <div style={divStyle}>
   ...
   <h1> Reimbursement By Status</h1> <br/>
